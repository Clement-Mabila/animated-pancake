...
const questionSchema = z.object({
  ...
  fieldType:             z.enum(['text', 'textarea', 'select', 'multiselect', 'boolean', 'number', 'multi_entry', 'onboarding_document', 'checkpoint', 'orchestrator_user_selector', 'schedule_amend_selector', 'integration_block', 'contact_picker', 'fleet_robot_register']),
